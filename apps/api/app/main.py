...
from app.api.routers import health, auth, workspace, home, missions, memories, content, deliverables, attention, search, integrations, calendar, gmail, drive, agents, agent_runs, tools, context, evaluations, admin_agents, policies, delegations, automations, insights, workflows, workflow_ai, finops, infrastructure, reliability, governance, identity, scim, dlp, knowledge, agent_mesh, decision_intelligence, workflow_optimization, events, operations, graph, knowledge_governance, enterprise_evaluation, model_gateway, agent_runtime_v2, learning_fabric, skill_fabric, capability_registry, mission_orchestration, decision_engine, governance_v2, security, secops, resilience, finops_v2, collaboration_v2, operating_graph, strategic_planning, portfolio_intelligence, execution_governance, performance_intelligence, predictive_operations, prescriptive_intelligence, adaptive_decision_governance, continuity_intelligence, crisis_intelligence, threat_intelligence, foresight_intelligence, adaptive_strategy, execution_intelligence, operating_model, transformation, transformation_portfolio, transformation_control, transformation_intelligence, transformation_foresight, transformation_decisions, transformation_decision_learning, transformation_governance, transformation_simulation, transformation_war_room, transformation_recovery, transformation_resilience_engineering, transformation_resilience_portfolio, transformation_resilience_sensing, transformation_resilience_command_center, transformation_resilience_decision_lifecycle, transformation_resilience_decision_learning, transformation_resilience_decision_knowledge, transformation_resilience_knowledge_governance, transformation_resilience_knowledge_operations, transformation_resilience_knowledge_assurance_planning, transformation_resilience_knowledge_assurance_control, transformation_resilience_knowledge_assurance_coordination, transformation_resilience_knowledge_assurance_conflicts, transformation_resilience_assurance_intelligence, transformation_resilience_assurance_foresight, transformation_resilience_assurance_interventions, transformation_resilience_assurance_command, transformation_resilience_cross_domain, transformation_resilience_digital_twin, transformation_resilience_stress, transformation_resilience_optimization, transformation_resilience_learning, transformation_resilience_governance
...
app.include_router(tools.router, prefix=settings.API_V1_STR, tags=["Tool Fabric"])
app.include_router(context.router, prefix=settings.API_V1_STR, tags=["Context Fabric"])
...
app.include_router(transformation_resilience_assurance_command.router, prefix=settings.API_V1_STR, tags=["Enterprise Transformation Resilience Assurance Command & Control 2.0"])
app.include_router(transformation_resilience_cross_domain.router, prefix=settings.API_V1_STR, tags=["Enterprise Transformation Resilience Cross-Domain Assurance Intelligence 2.0"])
app.include_router(transformation_resilience_digital_twin.router, prefix=settings.API_V1_STR, tags=["Enterprise Transformation Resilience Digital Twin 2.0"])
app.include_router(transformation_resilience_stress.router, prefix=settings.API_V1_STR, tags=["Enterprise Transformation Resilience Stress Testing 2.0"])
app.include_router(transformation_resilience_optimization.router, prefix=settings.API_V1_STR, tags=["Enterprise Transformation Resilience Optimization 2.0"])
