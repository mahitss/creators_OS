...
async def list_automations(
    ...
    triggers = await proactive_service.list_workspace_triggers(session, workspace_id)
    return triggers
...
async def create_automation(
    ...
    trigger = await proactive_service.create_trigger(session, trigger_in, created_by=x_user_id)
    return trigger
...
async def get_dead_letters(
    ...
    letters = await proactive_service.list_dead_letters(session, workspace_id)
    return letters
