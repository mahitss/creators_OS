...
async def search_knowledge(
    ...
    return await knowledge_service.search_knowledge(session, req, x_user_id, x_user_role)
...
async def ask_knowledge(
    ...
    return await knowledge_service.ask_knowledge(session, req, x_user_id, x_user_role)
...
async def get_knowledge_graph(
    ...
    return await knowledge_service.get_knowledge_graph(session, workspace_id)
