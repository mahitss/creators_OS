# V1.0 Month-1 Observability Gaps Specification
...
| **GAP-04** | Client Telemetry | Client-side page rendering timing metrics (Web Vitals) | Frontend performance relies on server-side p95 latencies | Next.js OpenTelemetry web vitals reporting agent | **P3** |
